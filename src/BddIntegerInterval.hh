...
#ifndef BDDINTEGERINTERVAL_HH_
#define BDDINTEGERINTERVAL_HH_
...
public:
  ...
  /** @brief Instantiate the BddIntegerInterval with the integer interval [lb;ub]\n 
   *  optionally, provide the bdd variable ids to reprsent the integer interval **/
  BddIntegerInterval(const Cudd& manager,
