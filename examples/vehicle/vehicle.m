...
%
% so that the files: problemdomain.scs
%                    obstacles.scs
%                    target.scs
%                    reach.scs
% are created
...
plotCells(set,'projection',[1 2],'facecolor','none','edgec',colors(1,:),'linew',.1)
...
plotCells(set,'projection',[1 2],'facecolor',colors(1,:)*0.5+0.5,'edgec',colors(1,:),'linew',.1)
...
%set=UniformGrid('target.scs');
plotCells(set,'projection',[1 2],'facecolor',colors(2,:)*0.5+0.5,'edgec',colors(2,:),'linew',.1)
